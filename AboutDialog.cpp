...
const wxString AboutDialog::AGE_VER = "2023.05.27";
    ...
    : wxDialog(parent, -1, "About Advanced Genie Editor", wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE | wxNO_DEFAULT)
{
    ...
    SolidText *Credits = new SolidText(this, "Credits:\nYkkrosh - GeniEd 1 source code"
        ...
        "\ngoto-bus-stop - language.ini support\nBF_Tanks - some help\nDonnieboy, Sarn, chab - tooltip texts\ngagman - new icon");
    ...
    wxHyperlinkCtrl *SourceLinkGUI = new wxHyperlinkCtrl(this, wxID_ANY, "withmorten/AGE on GitHub",
        "https://github.com/withmorten/AGE", wxDefaultPosition, wxDefaultSize,
        wxNO_BORDER | wxHL_CONTEXTMENU | wxHL_ALIGN_LEFT);
    wxHyperlinkCtrl *SourceLinkFIO = new wxHyperlinkCtrl(this, wxID_ANY, "withmorten/genieutils on GitHub",
        "https://github.com/withmorten/genieutils", wxDefaultPosition, wxDefaultSize,
        wxNO_BORDER | wxHL_CONTEXTMENU | wxHL_ALIGN_LEFT);
