...
void AGE_Frame::OnOpen(wxCommandEvent&)
{
    ...
    if(!SkipOpenDialog)
    {
        ...
        wxConfig Config("", "", "AGE2MW\\ConfigWindow"+lexical_cast<std::string>(window_num + 1), "", wxCONFIG_USE_LOCAL_FILE | wxCONFIG_USE_RELATIVE_PATH);
    ...
    {   // Without these, nothing can be edited.
        ...
        DefAoE2Armors.Add("31 - HD Anti-Leitis");
        DefAoE2Armors.Add("32 - HD Condottiero");
        DefAoE2Armors.Add("33 - HD Organ Gun Secondary Projectile");
        DefAoE2Armors.Add("34 - HD Fishing Ship");
        DefAoE2Armors.Add("35 - HD Mameluke");
        DefAoE2Armors.Add("36 - HD Hero & King");
        ...
        else
        {
            ...
            effect_type_names.Add(lexical_cast<std::string>(loop) + " - AoC + UP 1.5 only");
        }
...
void AGE_Frame::LoadIni(const wxString &filename) {
    ...
    while(getline(infile, line))
    {
        ...
        unsigned long ID = std::stoul(line.substr(0, split));
